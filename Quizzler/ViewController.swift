...
class ViewController: UIViewController {
    ...
    func nextQuestion() {
        if questionNumber <= 12 {
            ...
            let alert = UIAlertController(title: "Awesome", message: "You've finished all of the questions. Do you want to start over again?", preferredStyle: .alert)
